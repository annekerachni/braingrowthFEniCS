...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output', help='Output path to write 3D sphere/ellipsoid (Gmsh object: .msh)', type=str, required=True, default='./data/gmsh/sphere_algoDelaunay1_tets005.msh' )
