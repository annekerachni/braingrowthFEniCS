...
def run_simulation_with_distinct_parameter_values(inputmesh_path,
    ...
    # script command line
    simulation_command = "python3 -i main_solverFg0.py" + \
