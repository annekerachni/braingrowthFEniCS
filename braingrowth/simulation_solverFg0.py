# elastodynamic brain growth model (dynamic structural mechanics), growth tensor preset at t=0

""" python3 -i simulation_solverFg0.py -i './data/sphere_algoDelaunay1_tets005_refinedcoef5.xml' -n True -p '{"H0": 0.03, "K": 100.0, "muCortex": 20.0, "muCore": 1.0, "rho": 0.01, "damping_coef": 0.5, "alphaTAN": 4.0, "alphaRAD": 0.0, "grTAN": 1.0, "grRAD": 1.0, "alphaM": 0.2, "alphaF": 0.4, "T": 1.0, "Nsteps": 100, "linearization_method":"newton", "linear_solver":"gmres", "preconditioner":"ilu"}' -o './results/' """
...
if __name__ == '__main__':
    ...
    xdmf_file.write(d2s, 0.0)
    xdmf_file.write(H, 0.0)
    xdmf_file.write(gm, 0.0)

    xdmf_file.write(BoundaryMesh_Nt, 0.0)
    xdmf_file.write(Mesh_Nt, 0.0)

    xdmf_file.write(dg_TAN, 0.0)
    xdmf_file.write(dg_RAD, 0.0)
    xdmf_file.write(Fg_T, 0.0)

    xdmf_file.write(mu, 0.0)
