...
from braingrowth.MRI_driven_parameters.FA import FA_2_growth_laws
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', help='Input mesh path (xml)', type=str, required=False, 
                        default='./data/dhcp/refined/dhcp21GW_17K_refined10.xml') 
    ...
    default={"21GW": './nifti_mesh/niftitomesh/transfer_niftivalues_to_meshnodes/results/21GW/meshXML17Ktets_MRIniivalues_NearestNeighbor_21GW_homogeneizeCortexLabels.vtk'})
    ...
    outputfolderpath = './simulations/dhcp/22nov/'
