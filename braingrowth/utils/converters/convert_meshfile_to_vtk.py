...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', help='Input mesh (.xml, .msh, .mesh) path', type=str, required=False, default='./data/dhcp21_145K_refinedcoef20.xml' ) 
    parser.add_argument('-o', '--output', help='Output mesh path (.vtk)', type=str, required=False, default='./data/dhcp21GW.vtk')
    ...
    if inputmesh_format == 'xml': # FEniCS mesh
