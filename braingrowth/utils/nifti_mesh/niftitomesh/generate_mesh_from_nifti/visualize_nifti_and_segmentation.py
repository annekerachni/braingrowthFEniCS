...
if __name__ == '__main__':
    ...
    python3 -i visualize_nifti_and_segmentation.py 
            -i '{   "nifti_T1":'./database/dhcp_fetal_atlas/fetal_brain_mri_atlas/structural/t1-t21.00.nii.gz', 
                    "nifti_T2":'./database/dhcp_fetal_atlas/fetal_brain_mri_atlas/structural/t2-t21.00.nii.gz',
    ...
    parser.add_argument('-i', '--inputdata', help='Path to the orginal nifti file (.nii) + Path to the associated segmentation file (.nii)', type=json.loads, required=False, 
                        default={ 
                                 ...
                                 "nifti_T1":'./database/dhcp_fetal_atlas/fetal_brain_mri_atlas/structural/t1-t21.00.nii.gz',
