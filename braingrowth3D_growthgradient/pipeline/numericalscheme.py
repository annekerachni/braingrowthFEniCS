...
class MassResForm:
    ...
    def __init__(self, 
        ...
        self.residual_form = self.material.rho * fenics.dot(a_solution, v_test) * fenics.Measure("dx") 
...
class DampingResForm:
    ...
    def __init__(self, 
        ...
        self.residual_form = self.material.damping * fenics.dot(v_solution, v_test) * fenics.Measure("dx") 
...
class StiffnessResForm:
    ...
    def __init__(self, 
        ...
        if self.formulation == "PKII":
            self.residual_form = fenics.inner(material.compute_PKII_stress(), fenics.grad(v_test)) * fenics.Measure("dx") 
            
        """ elif self.formulation == "Cauchy": 
            self.residual_form = fenics.inner(material.compute_Cauchy_stress(), fenics.grad(v_test)) * fenics.Measure("dx") """
...
class VolumeForcesResForm:
    ...
    def __init__(self,
        ...
        self.residual_form = fenics.dot(body_forces, v_test) * fenics.Measure("dx") 
