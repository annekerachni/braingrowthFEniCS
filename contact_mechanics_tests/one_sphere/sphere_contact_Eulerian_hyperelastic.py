...
############################
output_folder = "./contact_mechanics/results/one_sphere_Eulerian_hyperelastic/"
...
# Export results
################
file_results = fenics.XDMFFile( os.path.join(output_folder, "results_sphere_contact_SIGMA_Contact_Hyperelastic.xdmf") )
