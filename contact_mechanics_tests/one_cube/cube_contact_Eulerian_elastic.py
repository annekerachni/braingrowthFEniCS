...
############################
output_folder = "./contact_mechanics/results/cube_Eulerian_elastic/"
...
# Export results
################
file_results = fenics.XDMFFile( os.path.join(output_folder, "results_cube_contact_SIGMA_Contact_Elastic.xdmf") )
