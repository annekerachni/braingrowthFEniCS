...
#os.environ['DISPLAY'] = ':1' # remove display mode


for tGW in range(21, 37):
      # LOAD MESH
      # ---------
      # mesh = sio.load_mesh("./data/example_mesh.gii")
      mesh = sio.load_mesh('./data/dhcp_fetal_atlas/WM_Right/fetal.week{}.right.wm.surf.gii'.format(tGW)) 
      # pial: './data/dhcp_fetal_atlas/pial_Right/fetal.week{}.right.pial.surf.gii'
      # WM/GM: './data/dhcp_fetal_atlas/WM_Right/fetal.week{}.right.wm.surf.gii' 
      ...
      splt.save_image(curvature_scene_viewer[0], './metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_pial_Right_{}GW_MeanCurvature.png'.format(tGW, tGW))
      plt.close()
      """
      ...
      plt.savefig('./metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_WM_Right_{}GW_PowerSpectrum.png'.format(tGW, tGW), bbox_inches='tight')
      ...
      plt.savefig('./metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_WM_Right_{}GW_PowerSpectrum_Sulci.png'.format(tGW, tGW), bbox_inches='tight')
      ...
      plt.savefig('./metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_WM_Right_{}GW_PowerSpectrum_Gyri.png'.format(tGW, tGW), bbox_inches='tight')
      ...
      LocalDominantBands_scene_viewer = splt.pyglet_plot(mesh, values=loc_dom_band, color_map='jet',
                                                      ...
                                                      alpha_transp=255, background_color=None,
                                                      default_color=[100, 100, 100, 200], cmap_bounds=None)
      splt.save_image(LocalDominantBands_scene_viewer[0], './metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_WM_Right_{}GW_LocalDominantBands.png'.format(tGW, tGW))
      plt.close()
      """

      # Export Spangy analysis (.txt)
      # -----------------------------
      output_path = './metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_WM_Right_{}GW_SPANGY_ANALYSIS.txt'.format(tGW, tGW)
      ...
      # --------------------------------------------------------------
      np.savetxt('./metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_WM_Right_{}GW_SPANGY_ANALYSIS_group_indices.csv'.format(tGW, tGW), group_indices, delimiter=",")
      np.savetxt('./metrics/slam_Spangy/dHCP_fetal_RESULTS/{}GW/dHCP_WM_Right_{}GW_SPANGY_ANALYSIS_eigenVals.csv'.format(tGW, tGW), eigVal, delimiter=",")
