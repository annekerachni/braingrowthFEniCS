...
def msh_to_xml_2D(input_file_msh, output_file_xml): 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', help='Input mesh (.vtk, .msh, .mesh) path', type=str, required=False, default='./data/ellipsoid_algoDelaunay1_tets002.msh' ) # './data/dhcp/mesh/dhcpWholefull/dhcp21Whole_veryfine_3M.mesh'; './data/ellipsoid_284K.mesh'
    parser.add_argument('-o', '--output', help='Output mesh path (.xml)', type=str, required=False, default='./data/ellipsoid_algoDelaunay1_tets002.xml') # './data/dhcp/mesh/dhcpWholefull/dhcp21Whole_veryfine_3M.xml'; './data/ellipsoid_284K.xml'
