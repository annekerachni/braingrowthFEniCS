# elastodynamic brain growth model (dynamic structural mechanics), growth tensor updated at each timestep
...
if __name__ == '__main__':
    ...
    # collisions (fcontact_global_V) have to be detected at each step
        ...
        xdmf_file.write(BoundaryMesh_Nt, t) 
        xdmf_file.write(Mesh_Nt, t) 
