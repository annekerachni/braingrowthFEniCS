"""This module enables to find the idoine parameters value for braingrowthFEniCS"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--inputmeshpathlist', help='Input mesh path', type=list, required=False, 
    ...
    parser.add_argument('-v', '--parametervalues', help='List of nsteps values to test (in multiprocessing)', type=list, required=False, 
    ...
    parser.add_argument('-ro', '--referenceoutputfolderpath', help='Reference output path to modify', type=str, required=False, 
                        default='./results/multiple_timesteps/H003_K100_muCortex20_muCore1_alphaTAN4_rho001_damp05_tmax1_nsteps100/') 
    ...
    for inputmesh_path in input_meshes_list:
        ...
        #pool.map(os.system, all_simulations_to_launch)
