...
""" python3 -i main_solverFg0.py -i './data/fetal_dhcp_atlas/21GW/dhcp21GW_17Ktets.xml' -n True -p '{"H0": 0.04, "K": 100.0, "muCortex": 20.0, "muCore": 4.0, "rho": 0.01, "damping_coef": 10.0, "alphaTAN": 5.0, "alphaRAD": 0.0, "grTAN": 1.0, "grRAD": 1.0, "alphaM": 0.2, "alphaF": 0.4, "T0": 0.0, "Tmax": 1.0, "Nsteps": 100, "linearization_method":"newton", "linear_solver":"gmres", "preconditioner":"sor"}' -o './braingrowth/results/25nov/' """
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output', help='Output folder path', type=str, required=False, 
                        default='./braingrowth/results/solverFg0/dhcp21GW708Ktets_H004_K100_muCortex20_muCore4_rho001_alphaTAN5_contactGlobalSmallCorrections_abs3re2_/')
    ...
    dg_TAN.assign( fenics.project(grTAN * alphaTAN * gm * grNoGrowthZones * ((1 - alphaF) * dt), S) )
