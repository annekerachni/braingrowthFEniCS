...
def FA_evolution_law_homogeneous(meshFEniCS, T0, times, type_of_law):
    ...
    mesh_coordinates = meshFEniCS.coordinates()
...
if __name__ == '__main__':
    ...
    # Parameters
    ############
    meshFEniCS = fenics.Mesh('./data/fetal_dhcp_atlas/21GW/dhcp21GW_17Ktets.xml' )
    ...
    ###########################
    outfilepath = './braingrowth/MRI_driven_parameters/FA/longitudinal_FA_values/FA_longitudinal_homogeneousNodalValue.csv'
    ...
    T0_GW = 21
    FA_nifti_file_path_T0GW = '/home/latim/BrainGrowth_database/dhcp_fetal_atlas/fetal_brain_mri_atlas/diffusion/fa-t{}.00.nii.gz'.format(T0_GW)
    ...
    mesh_meshio = transfer_niftivalues_to_meshnodes_in_simulation.load_FAdata_onto_mesh_nodes(meshFEniCS, 
                                                                                              FA_nifti_file_path_T0GW, 
                                                                                              interpolation_mode='nearest_neighbor') 
    
    
    # Get nodal FA 
    from braingrowth.MRI_driven_parameters.FA import FA_to_growth_longitudinal 
    ...
    # Export dictionnary to csv
    ###########################
    outfilepath = './braingrowth/MRI_driven_parameters/FA/longitudinal_FA_values/FA_longitudinal_heterogeneousNodalValue_from21GWFAatlas.csv'
