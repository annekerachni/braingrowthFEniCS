...
class TractionResForm:
    ...
    def __init__(self,
        ...
        traction = fenics.Constant((0., 0.)) # 2D
    ...
    def __init__(self,
                 ...
                 BoundaryMesh_Nt,
                 v_test,
                 integration_measure_on_boundarymesh, brainsurface_mark):

        self.residual_form = fenics.dot( fenics.dot(cortex_material.compute_PKII_stress(), BoundaryMesh_Nt), v_test) * integration_measure_on_boundarymesh(brainsurface_mark)
    """
