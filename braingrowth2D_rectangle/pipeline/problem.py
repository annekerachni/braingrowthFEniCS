...
from braingrowth2D_rectangle.pipeline import boundaries, subdomains, growth, kinematics, material, numericalscheme
...
class NonLinearDynamicMechanicsProblem:
    ...
    def define_and_mark_brainsurface_boundary(self): # e.g. BrainSurface() for disk mesh; Top() for rectangle mesh
        self.brainsurface = boundaries.BrainSurface(self.preprocessedFEniCSmesh, self.boundaries)
