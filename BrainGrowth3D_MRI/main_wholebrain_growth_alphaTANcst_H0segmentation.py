...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output', help='Output folder path', type=str, required=False, 
                        default='./results/ECCOMAS_57/wholebrain/9SEPT/dHCPsurface21GW_wholebrain_Fgt_quasistatic_alphaTANcst_H0segmentation_DIRICHLETboundaries_GAP_dgRAD_calibration/')
    ...
    mesh_meshio = transfer_niftivalues_to_meshnodes_withITK_ECCOMAS.load_Segmentation_onto_mesh_nodes(mesh0, 
                                                                                                      Segmentation_nifti_file_path_T0, 
                                                                                                      interpolation_mode='nearest_neighbor')
    mesh_meshio.write(args.output + "mesh_Segmentation_values_{}GW".format(int(T0_in_GW)) + '.vtk') 
