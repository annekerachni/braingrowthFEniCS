...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', help='Input mesh path (.xml, .xdmf); mesh unit: millimeters', type=str, required=False, 
                        default="./data/21_28_36GW/transformed_niftis_meshes/transformed_dhcp21GW_isotropic_smoothed_TaubinSmooth50_refinedWidthCoef10.xdmf") 
                        # from dHCP volume niftis: "./data/21_28_36GW/transformed_niftis_meshes/transformed_dhcp21GW_isotropic_smoothed_TaubinSmooth50_refinedWidthCoef10.xdmf" (719399 tets) --> in millimeters
                        # from dHCP surface gifti mesh: "./data/dHCP_surface/fetal_week21_left_right_merged_V2.xdmf" (455351 tets) -->  in meters
    ...
    """parser.add_argument('-om', '--outputmesh', help='Output folder path', type=str, required=False, 
                        default='./results/distance_map_dHCPsurface21GW.xdmf')"""
    
    parser.add_argument('-on', '--outputnifti', help='Output folder path', type=str, required=False, 
                        default='./results/distance_map_dHCPvolume21GW_V2.nii.gz')
