...
@jit(parallel=True, forceobj=True)
def generate_binary_mask_removing_selected_parcels(segmentation_file_path, selected_parcels): 
    """
    Generate binary mask from the selected parcels among the provided segmentation parcels. 
    """
    provided_parcels_nib = nib.load(segmentation_file_path)  
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--inputdata', help='Path to the orginal nifti file (.nii) + Path to the associated segmentation file (.nii)', type=json.loads, required=False, 
                        default={ 
                                 ...
                                 "nifti":'/home/anne/Bureau/RFIAP/Data/GHOLIPOUR_raw_data/STA34.nii.gz',
                                 
                                 "segmentation":'/home/anne/Bureau/RFIAP/Data/GHOLIPOUR_raw_data/STA34_regional.nii.gz'
    ...
    parser.add_argument('-o', '--outputmaskednifti', help='Path to masked nifti (.nii.gz)', type=str, required=False, 
                        default='/home/anne/Bureau/RFIAP/Data/GHOLIPOUR_raw_data/STA34_WM_removed.nii.gz')
    ...
    binary_mask_data = generate_binary_mask_removing_selected_parcels(segmentation_path, selected_parcels) # generate_binary_mask_from_selected_parcels(segmentation_path, selected_parcels)
