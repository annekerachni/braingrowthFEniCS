...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--inputmesh', help='Path to input mesh (.xml, .xdmf, .stl)', type=str, required=False, 
                        default='./data/dHCP_raw/dhcpRight21GW_masked_20000faces_98000tets.xdmf') 
    ...
    parser.add_argument('-o', '--output', help='Path to output folder where to write mesh + loaded nifti values (.xdmf))', type=str, required=False, 
                        default='./MRI_driven_parameters/meshes_loaded_with_MRI_data/dhcpRight21GW_masked_20000faces_98000tets/')
