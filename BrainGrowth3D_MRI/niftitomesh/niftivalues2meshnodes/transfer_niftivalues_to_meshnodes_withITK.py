...
from BrainGrowth3D_MRI.niftitomesh.spatialorientationadapter_to_ras import apply_lps_ras_transformation, nifti_itk_analyzer, itk_coordinate_orientation_system_analyzer
...
if __name__ == '__main__':
    ...
    parser.add_argument('-of', '--outputfolder', help='Path to output folder where to write mesh + loaded nifti values)', type=str, required=True, 
                        default='./MRI_driven_parameters/meshes_loaded_with_MRI_data/')
