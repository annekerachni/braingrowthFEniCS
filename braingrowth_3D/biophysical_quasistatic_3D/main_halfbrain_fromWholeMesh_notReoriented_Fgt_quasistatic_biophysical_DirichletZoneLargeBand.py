...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--parameters', help='Simulation input parameters', type=json.loads, required=False, 
                        default={"H0": 2.5e-3, # [m]
                                 ...
                                 "nu": 0.45,
                                 "alphaTAN":10.0e-6, "alphaRAD": 0.0, "grTAN": 1.0, "grRAD": 1.0, # alphaTAN: [s⁻¹], alphaRAD: [s⁻¹] 
    ...
    parser.add_argument('-o', '--output', help='Output folder path', type=str, required=False, 
                        default='./results/halfbrain_fromWholeMesh_Fgt_quasistatic_biophysical/')
    ...
    # See: https://fenicsproject.discourse.group/t/how-to-mark-boundaries-to-a-circle-and-change-solution-from-cartesian-to-polar/5492/4
