...
if __name__ == '__main__':
    ...
    muCortex_values = [300, 600, 900, 1200, 1500, 3000, 4500, 6000] # [Pa]
    nu_min_max = [0.45] # [-]
            ...
            for nu in nu_min_max:
                for alphaTAN in alphaTAN_min_max : 
                    for dt in dt_min_max:
                        ...
                        output_path = "./results/brain_growth_sensititivy_analysis_muCortex/dHCPsurface_fetalweek21pialsurf129960faces456026tets_H{}_muCortex{}_muCore{}_nu{}_alphaTAN{}_dt{}/".format(str(H0).replace('.', "_"), str(muCortex), str(muCore), str(nu).replace('.', "_"), str(alphaTAN).replace('.', "_").replace('-', "_"), str(dt))
