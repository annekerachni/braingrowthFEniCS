            ...
            for nu in nu_min_max:
                for alphaTAN in alphaTAN_min_max : 
                    for dt in dt_min_max:
                        ...
                        output_path = "./results/sphere_growth_sensititivy_analysis_H0/sphere257Ktets_H{}_muCortex{}_muCore{}_nu{}_alphaTAN{}_dt{}/".format(str(H0).replace('.', "_"), str(muCortex), str(muCore), str(nu).replace('.', "_"), str(alphaTAN).replace('.', "_").replace('-', "_"), str(dt))
