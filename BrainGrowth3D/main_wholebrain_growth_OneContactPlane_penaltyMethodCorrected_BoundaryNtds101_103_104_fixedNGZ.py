...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output', help='Output folder path', type=str, required=False, 
                        default='./results/brain_growth_OneRigidPlane_penaltyMethodCorrected_BoundaryNt101_103_104_dirichletNoGrowthZone/')
    ...
    # Subdomains
    ############
    build_mesh_cell_markers = fenics.MeshFunction("size_t", mesh, mesh.topology().dim()) 
